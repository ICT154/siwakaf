<div style="padding:20px; clear:both; min-height:600px;">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form action="<?= base_url("proses/wakaf_masjid_" . $page . "") ?>" method="post" class="form-horizontal">
                ...
                <!-- <div class="form-group">
                    <label for="" class="col-sm-3 control-label no-padding-right">ID DATA PENGELOLA : </label>

                    <div class="col-sm-9">
                        <input type="text" class="col-xs-10 col-sm-5" id="id_data_pengelola" name="id_data_pengelola" autocomplete="off" required="" value="<?= $bow->id_data_pengelola ?>">
                    </div>
                </div> -->
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label no-padding-right">NAMA MASJID : </label>
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label no-padding-right">QOYYIM : </label>
                ...
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a href="<?= base_url('dash/wakaf_masjid') ?>" class="btn"><i class="ace-icon fa fa-undo bigger-110"></i>Kembali</a>
                </div>
            </form>
        </div>
    </div>
