<div style="padding:20px; clear:both; min-height:600px;">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form action="<?= base_url("proses/wakaf_pesantren_" . $page . "") ?>" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label no-padding-right">NAMA PESANTREN : </label>
                ...
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a href="<?= base_url('dash/wakaf_pesantren') ?>" class="btn"><i class="ace-icon fa fa-undo bigger-110"></i>Kembali</a>
                </div>
            </form>
        </div>
    </div>
