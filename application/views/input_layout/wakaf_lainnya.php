<div style="padding:20px; clear:both; min-height:600px;">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form action="<?= base_url("proses/wakaf_lainnya_" . $page . "") ?>" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label no-padding-right">PENGELOLA : </label>
...
<script>
    ...
    $('#wakaf_lainnya').attr('class', 'active');
</script>