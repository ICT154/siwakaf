        ...
        <table id="simsple-table" class="table  table-bordered table-hover">
            <thead>
                <tr class="tblhead">
                    ...
                    <th class="tblhead">KETUA JAMAAH</th>
                    <th class="tblhead">ALAMAT</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                <tr>
                    <td>
                        ...
                        <a href="#!"
                            onclick="showdet_v2('<?= $no; ?>', '<?= $row->id_pimpinan_jamaah ?>', 't_pimpinan_jamaah','id_pimpinan_jamaah')"
                        ...
                        <a href='<?= base_url("dash/e_p_jamaah/" . $row->id_pimpinan_jamaah . "") ?>' class="green">
                            <i class="ace-icon fa fa-pencil bigger-130 tooltip001" data-toggle="tooltip"
                                title="Edit"></i>
                        </a>
                        &nbsp;
                        <a href="#!" data-id="<?= $row->id_pimpinan_jamaah ?>" class="red" onclick="del(this)">
