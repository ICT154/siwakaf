...
<br><br>
<table id="tabelwakaf" class="table table-bordered table-hover">
    <thead>
        <tr>
            <th>
    ...
    <tbody id="tabwak">
        ...
        <tr>
            <td>
                <a href="<?= base_url('dash/lap_wakaf_det_pr/' . $key->id_penerimaan_wakaf . '') ?>"
                    class="btn btn-xs btn-danger"><i class="ace-icon fa fa-angle-double-down"></i>Print Pdf</a>
            </td>
            <td>
                <?= $u; ?>
            </td>
