...
<div class="row">
    <div class="col-xs-12">
        ...
        <br><br>
        <form method="post" id="f_add_w_lainnya" class="form-horizontal" enctype="multipart/form-data"
            action="<?= base_url('proses/edit_penerimaan_wakaf') ?>">
            ...
            <input type="hidden" value="<?= $bow->id_utama ?>" id="idpwak" name="idpwak">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select name="inputPimpinan" id="opt_pimpinan">
                        <?php
                        $gett = $this->db->get("t_pimpinan_jamaah")->result();
                        foreach ($gett as $row) {
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" class="col-xs-10 col-sm-5" id="inputJenisWakaf" name="inputJenisWakaf" required
                        autocomplete="off" value="<?= $bow->jenis_wakaf ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea type="text" class="col-xs-10 col-sm-5" id="alamat" name="inputAlamatWakaf" required
                        autocomplete="off"><?= $bow->alamat_peruntukan ?>"</textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="number" class="col-xs-10 col-sm-5" id="inputNoTelpWakaf" name="inputNoTelpWakaf"
                        autocomplete="off" onkeydown="return hanyaAngka(this);" value="<?= $bow->telp_peruntukan ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="email" class="col-xs-10 col-sm-5" id="inputEmailWakaf" name="inputEmailWakaf"
                        autocomplete="off" value="<?= $bow->email_peruntukan ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" class="col-xs-10 col-sm-5" id="inputPenerima" name="inputPenerima" required
                        autocomplete="off" value="<?= $bow->penerima_nama ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">NO TELP :
                ...
                <div class="col-sm-5">
                    <input type="number" class="col-xs-10 col-sm-5" id="inputNoTelpPenerima" name="inputNoTelpPenerima"
                        autocomplete="off" onkeydown="return hanyaAngka(this);" value="<?= $bow->penerima_telp ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">EMAIL :
                ...
                <div class="col-sm-7">
                    <input type="email" class="col-xs-10 col-sm-5" id="inputEmailPenerima" name="inputEmailPenerima"
                        autocomplete="off" value="<?= $bow->email_penerima ?>">
                </div>
            </div>
            <br>
            <div class="form-group">
            ...
            <div class="form-group" id="alamatmuwakif">
                ...
                <div class="col-sm-9">
                    <textarea type="text" class="col-xs-10 col-sm-5" id="inputAlamatMuwakif" name="inputAlamatMuwakif"
                        autocomplete=""><?= $bow->alamat_pemberi ?></textarea>
                    <!-- <div class="col-sm-1 action-buttons">
                        <a href="#!" onclick="getMapCoor2()" class="green bigger-140 tooltip001 " title="Get Coordinat">
                            <img src=" <?= base_url('vendor/') ?>assets/images/gmaps.gif" width="30px">
                        </a>
                    </div> -->
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="col-xs-10 col-sm-5" id="inputNoSertifikat" name="inputNoSertifikat"
                        autocomplete="" value="<?= $bow->no_serti ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" class="col-xs-10 col-sm-5" id="inputLuasTanah" name="inputLuasTanah"
                        autocomplete="" onkeydown="return hanyaAngka(this);" value="<?= $bow->tanah ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" class="col-xs-10 col-sm-5" id="inputLuasBangunan" name="inputLuasBangunan"
                        autocomplete="" onkeydown="return hanyaAngka(this);" value="<?= $bow->bangunan ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="col-xs-10 col-sm-5" id="inputEstBang" name="inputEstBang" autocomplete=""
                        onkeydown="return hanyaAngka(this);" value="<?= $bow->tnh_bg ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="col-xs-10 col-sm-5" id="inputEstNilai" name="inputEstNilai"
                        autocomplete="" onkeydown="return hanyaAngka(this);" value="<?= $bow->tnh_est ?>">
                </div>
            </div>
            <br>
            <br>
...
<div class="modal fade" id="modalinven_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" id="">
            ...
            <div class="modal-body" id="edit_inv">

            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" id="btn" class="btn btn-primary" onclick="s_e_inven()">Save changes</button>
            </div>
        </div>
    </div>
</div>
